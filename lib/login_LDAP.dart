...
class LoginLDAP extends StatefulWidget {
  @override
  _LoginLDAPState createState() => _LoginLDAPState();
}

class _LoginLDAPState extends State<LoginLDAP> {
  ...
  Future<void> registerUser(BuildContext context) async {
    ...
    if (login.isEmpty || email.isEmpty || phoneNumber.isEmpty || password.isEmpty) {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://retroispk.ru/registerLDAP'),
